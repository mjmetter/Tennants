...
<g:each var="pet" in="${ownerBean.pets}">
    ...
    <table class="table-buttons">
        <tr>
            <td>
                <g:form method="GET" url="[controller:'pet', action:'edit', id:pet.id]"
                        name="formEditPet${pet.id}">
                    <p class="submit"><input type="submit" value="Edit Pet"/></p>
                </g:form>
            </td>
            <td>
                <g:form method="GET" url="[controller:'pet', action:'addVisit', id:pet.id]"
